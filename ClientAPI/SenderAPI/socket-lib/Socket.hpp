...
namespace Socket
{
    ...
    public:
		...
		void send_1dbuffer(unsigned char* buffer, size_t lenth);
		void send_2dbuffer(unsigned char* buffer, size_t width, size_t height);
        cv::Mat receive_buffer(size_t width, size_t height);
    };
}
